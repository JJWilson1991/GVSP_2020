...
ro<-unique(nest_o$data[[6]]$Host_species)
  ...
  ManualColours<- c(`African buffalo`= "green",Cattle='green',Raccoon='red', ch='yellow', la="blue",pe="purple", ro="black")

pp<-orders4[,c(1,2,3)]

bipartite_D3(pp, ColourBy = 1, colouroption = "manual", NamedColourVector = ManualColours, SortPrimary = hi_host, SortSecondary = lo_host, filename = "Species_net")
```
```{r}
...
bipartite_D3(sst2, ColourBy = 1, colouroption = "brewer", PrimaryLab = "Reservoir Host Order", SecondaryLab = "Spillover Host Order", SiteNames = "Frequency", filename = "Order_net")
